    ...
    public static int[][] solution(int n) {
        ...
        while (count <= n * n) {
            ...
            for (int i = rotate; i < size; i++) {
                answer[rotate][i] = count++;
            }

            for (int j = rotate + 1; j < size; j++) {
                answer[j][size - 1] = count++;
            }

            for (int k = size - 2; k >= rotate; k--) {
                answer[size - 1][k] = count++;
            }

            for (int l = size - 2; l > rotate; l--) {
                answer[l][rotate] = count++;
            }
